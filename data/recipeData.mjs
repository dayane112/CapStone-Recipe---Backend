const recipe = [
    {
        ...
        direction: [
            ...
            "Place an aluminum roasting pan on the bottom of the oven. Fill 1 inch deep with boiling water. Slide loaves onto baking stone in a cold oven. I use this pizza paddle to put the bread into the oven.",
            "Bake at 400°F for 35 to 45 minutes, until the loaves are golden brown and sounds hollow when tapped.",
            "Allow bread to cool before slicing. It really helps to have a sharp serrated bread knife for smooth cuts and so the bread doesn't tear.",
            "Alternate method:",
        ...
        image: 'http://localhost:3000/images/Bread.JPG'
    },
    {
        ...
        image: 'http://localhost:3000/images/SweetPotatoCasserole.JPG'
    },
]
